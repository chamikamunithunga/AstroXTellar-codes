<?php
    ...
    if(isset($_SESSION['email'])){
       $userState  = "Profile";
       $usernagivatelink = "./Frontend/profile.php";
    }else{
        $userState = "Login";
...
<body>
    ...
    <div class="scroll-container">
        <div class="scroll-text">Astroxtellar - The Ultimate Space Quiz!  &nbsp;  &nbsp; Can you answer the toughest space questions?  &nbsp;  &nbsp; Challenge yourself now! </div>
    </div>

    <img class="large-image" src="./imgs/bg.jpg" alt="Space Image">

    <div class="center-container">
        <button class="button" onclick="window.location.href='./Frontend/signup.php';">Let's Play</button>
    </div>
